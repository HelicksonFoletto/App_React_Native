    ...
    return(
        ...
        <View style={styles.buttonDicas}>
          <Text style={styles.TextCombate}>
            Mantenha seu dados atualizados para que juntos possamos criar um exército contra o mosquito e possamos evitar cada vez mais esse mal.
          </Text>
  
          <TouchableOpacity onPress={() => navigation.navigate('BemVindo3')}>
